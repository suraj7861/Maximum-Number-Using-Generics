...
public class Generics {
	...
	public static void main (String[] args) {
		...
		MaximumNumber maxInt = new MaximumNumber(32,23,12,43);
		//method call to find max Integer
		maxInt.findMaximum();
		
		//object creation for Float
		MaximumNumber maxfloat = new MaximumNumber(32.5f,23.3f,12.6f,43.5f);
		//method call to find max float
		maxfloat.findMaximum();
		
		//object creation for String
		MaximumNumber maxString = new MaximumNumber("Truck", "Ford", "Car","Tata");
